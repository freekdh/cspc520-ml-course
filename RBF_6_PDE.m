%Example 2: 
%2dydx1+dydx2=sin(x1) with y(0,x2) = cos(x2)
%interval [0,1]
...
plot3(x1,x2,y,'o')
hold on
%plot3(x1,x2,1+cos(x2-2*x1)-cos(x1),'o')
hold off

figure(2)
plot3(x1,x2,0.5*(1+2*cos(0.5*(2*x2-x1))-cos(x1)),'o','color',[0.9100    0.4100    0.1700]')

figure(3)
plot3(x1,x2,y-0.5*(1+2*cos(0.5*(2*x2-x1))-cos(x1)),'o')

sum(abs(y-0.5*(1+2*cos(0.5*(2*x2-x1))-cos(x1))))
